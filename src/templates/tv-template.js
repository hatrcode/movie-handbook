...
const TvTemplate = ({ id }) => {
  const url = `https://api.themoviedb.org/3/tv/${id}?api_key=${process.env.GATSBY_TMDB_API}&language=en-US&append_to_response=external_ids,keywords,credits,videos,similar`;
